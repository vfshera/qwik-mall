...
export default component$(() => {
  return (
    <footer class="relative z-10 bg-gray-50 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        ...
        <div class=" flex flex-wrap">
          <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class="text-brand-4 mb-7 text-base">
                Sed ut perspiciatis undmnis is iste natus error sit amet
                voluptatem totam rem aperiam.
              </p>
              <p class="text-brand-1 flex items-center text-sm font-medium">
                <span class=" mr-3">
                  <svg
                    width="19"
                    height="21"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="text-brand-1 mb-9 text-lg font-semibold">Resources</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
                    class="text-brand-4 hover:text-primary mb-2 inline-block text-base leading-loose"
                  >
                    SaaS Development
                  </a>
                </li>
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="text-brand-1  mb-9 text-lg font-semibold">Company</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="text-brand-1  mb-9 text-lg font-semibold">
                Quick Links
              </h4>
              <ul>
                <li>
