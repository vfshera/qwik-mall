    ...
    <footer class="relative z-10 bg-gray-50 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
      <div class="container mx-auto">
        <div class=" flex flex-wrap">
          <div class="w-full scecomm-container sm:w-2/3 lg:w-3/12">
            <div class="mb-10 w-full ">
              <h1 class="text-5xl font-bold text-brand-1">{SITE.name}</h1>
              <p class="text-brand-4 my-7 text-base">
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              <div class="mb-6 flex items-center">
                <a
                  href="#"
                  class=" hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="8"
                    height="16"
